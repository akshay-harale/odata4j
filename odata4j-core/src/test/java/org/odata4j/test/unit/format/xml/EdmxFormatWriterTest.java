...
public class EdmxFormatWriterTest {
  ...
  /**
     * Try checking validity of generated XML using BEA Stax library
     * @throws Exception
     */
  @Test
  public void testXMLValidity() throws Exception {
    String currentXMLOutputFactory = System.getProperty("javax.xml.stream.XMLOutputFactory");
    try {
      ...
      if (currentXMLOutputFactory != null) {
        // Restore factory
        System.setProperty("javax.xml.stream.XMLOutputFactory", currentXMLOutputFactory);
      } else {

...
/**
 * The Class OBindingResolverExtensions.
 */
public class OBindingResolverExtensions {

  /**
   * Gets the partial binding resolver.
   *
   * @return the partial binding resolver
   */
  ...
  /**
   * Gets the full binding resolver.
   *
   * @return the full binding resolver
   */
